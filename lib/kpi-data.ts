...
export const weeklyIndicatorsData: IndicateursData = {
  Indicateurs: [
    {
      Indicateur: "Taux d'Heures Supplémentaires",
      Valeur_Semaine: 6,
      Target: 5,
      Semaine_M1: 5,
      Semaine_M2: 7,
    ...
    {
      Indicateur: "Taux de Chômage technique",
      Valeur_Semaine: 2,
      Target: 1,
      Semaine_M1: 2,
      Semaine_M2: 2,
    ...
    {
      Indicateur: "Nombre de Réclamations Clients",
      Valeur_Semaine: 5,
      Target: 3,
      Semaine_M1: 4,
      Semaine_M2: 6,
