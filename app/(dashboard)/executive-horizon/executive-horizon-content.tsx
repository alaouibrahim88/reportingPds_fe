				...
				<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 flex-grow'>
					...
					<div className='kpi-card'>
						...
						<div className='flex-grow flex items-end justify-between gap-2 px-1 mt-6'>
							<div
								...
								style={{ height: '65%' }}
							>
								<div className='absolute -top-5 left-1/2 -translate-x-1/2 text-[9px] font-bold text-slate-400'>
									1.1M
								</div>
							</div>
							<div
						...
						<div className='grid grid-cols-4 mt-3 text-[9px] font-extrabold text-slate-400 uppercase text-center border-t border-slate-50 pt-2'>
							<span>S37</span>
							<span>S38</span>
							<span>S39</span>
					...
					<div className='kpi-card'>
						<div className='flex justify-between items-start'>
							<div>
								...
								<span className='text-[11px] font-bold text-sapphire-600 bg-sapphire-50 px-2 py-0.5 rounded-md'>
									Dans les temps
								</span>
							</div>
					...
					<div className='kpi-card bg-slate-50/30 border-dashed'>
						...
						<div className='flex-grow flex flex-col items-center justify-center'>
							...
							<div className='text-[11px] font-extrabold text-slate-400 uppercase tracking-[0.2em] mt-2'>
								Dossiers Ouverts
							</div>
						</div>
					...
					<div className='kpi-card'>
						...
						<div className='flex-grow flex flex-col justify-center gap-6'>
							...
							<div className='grid grid-cols-3 gap-1 text-[8px] font-extrabold text-slate-400 uppercase'>
