    ...
    <div className="grid grid-cols-3 gap-4 ">
      <div className="p-3 transition-all hover:bg-gray-50 rounded-lg border border-gray-200 hover:border-gray-300 group relative">
        ...
        <div className="relative">
          ...
          <div className="flex items-center space-x-2">
            <span className="text-lg font-bold text-white-900">999.83 Euro</span>
          ...
          <div className="text-xs text-white-600 mt-1 flex items-center">
            ...
            <span className="ml-1.5 text-white-700">900</span>
          </div>
        </div>
      </div>
      ...
      <div className="p-3 transition-all hover:bg-gray-50 rounded-lg border border-gray-200 hover:border-gray-300 group relative">
        ...
        <div className="relative">
          ...
          <div className="text-lg font-bold text-white-900">999.83</div>
        </div>
      </div>
    </div>
  );
